...
Flare can start an incident, run initial investigations, listen to human input, generate hypotheses, evidences and timeline:

https://github.com/user-attachments/assets/28691b6b-9461-446a-b391-29538a2d222f

Flare can validate claims against evidence, correct memory based on human input and propose mitigations:

https://github.com/user-attachments/assets/f3cda2a3-02ee-4491-9b7e-77f58e90bda6

Flare can change status of an incident, record action items, check for recovery once incident is resolved, and generate a postmortem:

https://github.com/user-attachments/assets/ddaaddce-5c79-4aba-ad1f-e78e9fbc5f80

Flare dashboard can also be used to view token usage:
